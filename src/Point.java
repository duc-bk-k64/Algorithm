...
//		ArrayList<Point> readPoints = point.readData("D:/eil51.tsp.txt");
//		for (int i = 0; i < readPoints.size(); i++) {
//			readPoints.get(i).print();
//		}
//		System.out.println(readPoints.get(1).distance(readPoints.get(1), readPoints.get(2)));
//
//	}
}
